...
import com.iprism.ecmoutboundmarketing.databinding.FragmentMyLeadCentralGovtBinding
...
class MyLeadCentralGovtFragment : Fragment() {

    private lateinit var binding: FragmentMyLeadCentralGovtBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentMyLeadCentralGovtBinding.inflate(inflater, container, false)
        setupCentralGovtAdapter()
        return binding.root
    }

    private fun setupCentralGovtAdapter() {
        var myLeadsCashAdapter = MyLeadCashAdapter(requireContext())
        var linearLayoutManager = LinearLayoutManager(requireContext())
        binding.centralRv.adapter = myLeadsCashAdapter
        binding.centralRv.layoutManager = linearLayoutManager
