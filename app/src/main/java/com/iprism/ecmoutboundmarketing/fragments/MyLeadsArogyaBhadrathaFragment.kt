...
import com.iprism.ecmoutboundmarketing.databinding.FragmentMyLeadsArogyaBhadrathaBinding
...
class MyLeadsArogyaBhadrathaFragment : Fragment() {

    private lateinit var binding: FragmentMyLeadsArogyaBhadrathaBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentMyLeadsArogyaBhadrathaBinding.inflate(inflater, container, false)
        setupArogyaBadrathaAdapter()
        return binding.root
    }

    private fun setupArogyaBadrathaAdapter() {
        var myLeadsCashAdapter = MyLeadCashAdapter(requireContext())
        var linearLayoutManager = LinearLayoutManager(requireContext())
        binding.arogyabadrathaRv.adapter = myLeadsCashAdapter
        binding.arogyabadrathaRv.layoutManager = linearLayoutManager
